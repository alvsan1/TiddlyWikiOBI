...
exports.startup = function(callback) {
    ...
    client.get("http://192.168.1.134:8080/snomedct?query=" + encodeURIComponent($tw.wiki.getTiddler("$:/linekedhealth/snomedct_l1_v1").fields.text),args, function (data, response) {	//acca    
    	...
    	*/	
    			if ( JSON.parse(JSON.stringify(changes))["$:/plugins/felixhayashi/tiddlymap/misc/defaultViewHolder"] ){
    				...
    				if (JSON.parse(vista)['config.know'] == "true" ) {
    					...
    					console.log(queryKw);
    					client.get("http://192.168.1.134:8080/snomedct?query=" + encodeURIComponent(queryKw),args, function (dataV, responseV) {	
